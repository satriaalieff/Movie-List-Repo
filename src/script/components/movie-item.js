class MovieItem extends HTMLElement {
  ...
  render() {
    ...
    this.innerHTML = `
      <div style="background-image: url('${imageUrl}')" class="aspect-[2/3] flex flex-col justify-end bg-cover bg-center rounded-xl overflow-hidden relative cursor-pointer">
